...
// Old 2-sentence summary too weak: models drifted back to verbose mid-conversation,
// worse after context compression pruned it away. Full rules with examples anchor
// behavior more reliably. Reads SKILL.md at runtime so edits to the source of truth
// propagate — no hardcoded duplication to go stale.
...
// Read SKILL.md — source of truth for caveman behavior.
// Plugin installs: __dirname=<plugin_root>/hooks/, SKILL.md at <plugin_root>/skills/caveman/SKILL.md
// Standalone installs: __dirname=$CLAUDE_CONFIG_DIR/hooks/, SKILL.md absent — falls back to hardcoded rules.
let skillContent = '';
try {
